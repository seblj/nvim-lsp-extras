...
local open_signature = function()
    ...
    for _, client in pairs(clients) do
        for _, trigger_char in ipairs(client.server_capabilities.signatureHelpProvider.triggerCharacters or {}) do
            ...
            if current_char == trigger_char or (current_char == " " and prev_char == trigger_char) then
                ...
                return vim.lsp.buf_request(0, "textDocument/signatureHelp", params, handler)
            end
        end
    end
end
