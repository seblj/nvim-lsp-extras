-- Credits to folke: https://github.com/folke/noice.nvim/blob/main/lua/noice/text/syntax.lua
...
---@param _ number namespace for the highlights
...
function M.highlight(buf, _, range, lang)
